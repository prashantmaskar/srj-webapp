...
include_once 'api/config/database.php';
 ...
 if (isset($_GET['id'])) {
            ...
            $branch_rs = mysqli_fetch_array($result, MYSQLI_ASSOC);
...
<div class="padding">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form ui-jp="parsley" id="editbranch" method="post">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="row m-b"> 
              <input type="hidden" name="branch_id" value="<?php echo $branch_rs['branch_id']; ?>" class="form-control" >                        
             <div class="col-sm-6">
              <label>Branch Name</label>
              <input type="text" value="<?php echo $branch_rs['branch_name']; ?>" name="branch_name" class="form-control" >                        
            </div>
            <div class="col-sm-6">
              <label>Branch Email</label>
              <input type="email" value="<?php echo $branch_rs['branch_email']; ?>" name="branch_email" class="form-control" >                        
            </div>
            </div>
            <div class="row m-b"> 
            ...
            <div class="col-sm-6">
              ...
              <input type="text" value="<?php echo $branch_rs['branch_telephone']; ?>" name="branch_tele" class="form-control" >                        
            </div>
            <div class="col-sm-6">
              <label>Branch Fax No</label>
              <input type="text" value="<?php echo $branch_rs['branch_fax']; ?>" name="branch_fax" class="form-control" >                        
            </div>
          </div>
            <div class="form-group">
                <label>Branch Location</label>
                <input type="text"  value="<?php echo $branch_rs['branch_address']; ?>"  name="branch_loc" class="form-control"  >   
            </div>
