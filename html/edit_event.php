...
include_once 'api/config/database.php';
 ...
 if (isset($_GET['id'])) {
            ...
            $event_rs = mysqli_fetch_array($result, MYSQLI_ASSOC);
...
<div class="padding">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form ui-jp="parsley" id="editevent" method="post" enctype="multipart/form-data">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="col-sm-6">
              ...
              <input type="hidden" name="event_id" value="<?php echo $event_rs['event_id']; ?>" class="form-control" >                        

              <input type="text" name="event_name" value="<?php echo $event_rs['event_name']; ?>"  class="form-control" >                        
            </div>
            <div class="col-sm-6">
              <label>Event Place</label>
              <input type="text" name="event_place" value="<?php echo $event_rs['event_place']; ?>"  class="form-control" >                        
            </div>
          </div>
          <div class="row m-b">
            <div class="col-sm-6">
              <label>Event Booth No</label>
              <input type="text" name="event_booth_no" value="<?php echo $event_rs['event_booth_no']; ?>"  class="form-control" >                        
            </div>
          <div class="col-sm-6">
              <label>Event Date</label>

              <input type='date' name="event_date"  value="<?php echo date('Y-m-d',strtotime($event_rs['event_date'])) ?>" class="form-control"   />
           
      </div>
    </div>
            <div class="form-group ">
              <div class="image_banner">
              <img class="w-40 avatar" src="http://srjcreations.com/asset/<?php echo $event_rs['event_image']; ?>">
              <input type="hidden" name="event_oimage_rc" value="<?php echo $event_rs['event_image']; ?>">

            </div>
              <label for="inputPassword" class="col-sm-3 form-control-label">Event Banner</label>
              <div class="col-sm-12">
          ...
          <div class="dker p-a text-right">
            <input type="submit" class="btn info" value="Update" name="Update">
          </div>
        </div>
      </form>
    </div>
