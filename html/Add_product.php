...
<div class="padding">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form ui-jp="parsley" id="addproduct" method="post" enctype="multipart/form-data">
        <div class="box">
 ...
 $run=mysqli_query($connection,$qry);
    ...
    <input type="checkbox" name="diamond_color[]" value="<?php echo $diamond_color['product_diamond_color_id']; ?>" >
...
<?php endwhile; ?>
 ...
 <div class="col-sm-2">
    <label class="checkbox-inline">
    <input type="checkbox" name="gold_color[]" value="<?php echo $gold_color['product_gold_color_id']; ?>" >
...
<?php endwhile; ?>
 ...
 <div class="col-sm-1">
    <label class="checkbox-inline">
    <input type="checkbox" name="diamond_quality[]" value="<?php echo $diamond_quality['product_diamond_quality_id']; ?>" >
...
<?php endwhile; ?>
 ...
 <div class="col-sm-1">
    <label class="checkbox-inline">
    <input type="checkbox" name="product_purity[]" value="<?php echo $product_purity['product_purity_id']; ?>" >
