...
include_once 'api/config/database.php';
 ...
 {  
  ...
  if (isset($_GET['id'])) {
            $query = "select * from region where region_id = ". $_GET['id']." ";
            $result = mysqli_query($connection,$query);
            $region_rs = mysqli_fetch_array($result, MYSQLI_ASSOC);
...
<div class="padding">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form ui-jp="parsley" id="editregion"  name="updateregion" method="post">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="col-sm-12">
              ...
              <input type="hidden" value="<?php echo $region_rs['region_id']; ?>" name="region_id">
              <input type="text" value="<?php echo $region_rs['region_name']; ?>" name="region_name"  class="form-control" >                        
            </div>
