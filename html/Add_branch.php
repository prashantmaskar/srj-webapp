...
<div class="padding">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form ui-jp="parsley" id="addbranch" method="post">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" name="branch_tele" class="form-control" >                        
            </div>
            <div class="col-sm-6">
              <label>Branch Fax No</label>
              <input type="text" name="branch_fax" class="form-control" >                        
            </div>
          </div>
            <div class="form-group">
                <label>Branch Location</label>
                <input type="text" name="branch_loc" class="form-control"  >   
            </div>
