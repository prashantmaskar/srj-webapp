...
<div class="padding">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form ui-jp="parsley" id="addsperson" method="post">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="s_user" class="form-control">                        
            </div>
            <div class="col-md-6">
              <label>Email</label>
            ...
            <div class="col-sm-6">
              <label>Phone</label>
              <input type="number" name="s_contact" class="form-control" placeholder="XXX XXXX XXX" >
            </div>
            <div class="col-sm-6">
              <label>Region</label>
