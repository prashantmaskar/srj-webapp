...
{
 $sql_query ="DELETE FROM admin_account WHERE admin_id=".$_GET['delete_id'];
 mysqli_query($connection,$sql_query);
 header("http://srjcreations.com/admin/html/view_salesperson.php");
} 
 ?>
...
{
 if(confirm('Sure To Remove This Sales Person ?'))
 {
  window.location.href='http://srjcreations.com/admin/html/view_salesperson.php?delete_id='+id;
 }
}
</script>
</head>
      ...
      <table ui-jp="dataTable" class="table table-striped b-t b-b">
        <thead>
          <tr>
            ...
            <th  style="width:25%">Person Email</th>
        ...
        <tbody>
           <?php
           $user_query = "select * from admin_account WHERE admin_type = 1";
            $user_result = mysqli_query($connection, $user_query);
             ?>
             <?php
                                                        while ($u_info = mysqli_fetch_array($user_result)) {
                                                            ?>
         <tr>
            <td><?php echo $u_info[0]; ?></td>
            <td><?php echo $u_info[2]; ?></td>
            <td><?php echo $u_info[3]; ?></td>
            <td><?php echo $u_info[3]; ?></td>
            <td><?php echo $u_info[4]; ?></td>
            <td>
             <a class="btn btn-icon btn-rounded btn-info" href="http://srjcreations.com/admin/html/edit_salesperson.php?id=<?php echo $u_info[0]; ?>">
                <i class="fa fa-pencil"></i>
              </a>
              <button class="btn btn-icon btn-rounded btn-danger" onclick="delete_id(<?php echo $u_info[0]; ?>);">
