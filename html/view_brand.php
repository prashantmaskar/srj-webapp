...
{
 $sql_query ="DELETE FROM brand WHERE brand_id=".$_GET['delete_id'];
 
 mysqli_query($connection,$sql_query);
 header("Location: http://srjcreations.com/admin/html/View_brand.php");
} 
 ?>
...
{
 if(confirm('Sure To Remove This Brand ?'))
 {
  window.location.href='http://srjcreations.com/admin/html/View_brand.php?delete_id='+id;
 }
}
</script>
</head>
      ...
      <table ui-jp="dataTable" class="table table-striped b-t b-b">
        <thead>
          <tr>
            ...
            <th  style="width:23%">Brand Name</th>
            <th  style="width:25%">Square Img</th>
            <th  style="width:25%">Recatangle Img</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img class="w-40 avatar" src = <?php echo $path.$b_info[3]; ?>" "></td>
            <td><img class="w-40 avatar" src = <?php echo $path. $b_info[2]; ?>></td>
            <td>
             <a class="btn btn-icon btn-rounded btn-info" href="http://srjcreations.com/admin/html/edit_brand.php?id=<?php echo $b_info[0]; ?>">
