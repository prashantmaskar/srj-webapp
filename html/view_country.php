...
{
 $sql_query ="DELETE FROM region_to_country WHERE region_id=".$_GET['delete_id'];
 mysqli_query($connection,$sql_query);
 header("http://srjcreations.com/admin/html/view_country.php");
} 
 ?>
...
{
 if(confirm('Sure To Remove This Country ?'))
 {
  window.location.href='http://srjcreations.com/admin/html/view_country.php?delete_id='+id;
 }
}
</script>
</head>
      ...
      <table ui-jp="dataTable" class="table table-striped b-t b-b">
        <thead>
          <tr>
            ...
            <th  style="width:25%">Country Created On</th>
            <th  style="width:25%">Action</th>
          </tr>
        </thead>
        <tbody>
           <?php
           $c_query = "select * from region_to_country";
            $c_result = mysqli_query($connection, $c_query);
             ?>
             <?php
                                                        while ($c_info = mysqli_fetch_array($c_result)) {
                                                            ?>
          <tr>
            <td><?php echo $c_info[0]; ?></td>
            <td><?php echo $c_info[1]; ?></td>
            <td><?php echo $c_info[2]; ?></td>
            
            <td>
             <a class="btn btn-icon btn-rounded btn-info" href="http://srjcreations.com/admin/html/edit_country.php?id=<?php echo $c_info[0]; ?>">
                <i class="fa fa-pencil"></i>
              </a>
              <button class="btn btn-icon btn-rounded btn-danger" onclick="delete_id(<?php echo $c_info[0]; ?>);">
