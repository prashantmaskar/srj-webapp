...
include_once 'api/config/database.php';
 ...
 if (isset($_GET['id'])) {
            ...
            $brand_rs = mysqli_fetch_array($result, MYSQLI_ASSOC);
...
<div class="padding">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form ui-jp="parsley" id="editbrand"  method="post" enctype="multipart/form-data">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <input type="hidden" name="brand_id" value="<?php echo $brand_rs['brand_id']; ?>" class="form-control" >                        
              <label>Brand Name</label>
              <input type="text" value="<?php echo $brand_rs['brand_name']; ?>" name="brand_name" class="form-control" >                        
            </div>
            <div class="image_banner">
              <img class="w-40 avatar" src="http://srjcreations.com/asset/<?php echo $brand_rs['brand_image_sq']; ?>">
              <input type="hidden" name="brand_oimage_sq" value="<?php echo $brand_rs['brand_image_sq']; ?>">
            </div>
           <div class="form-group ">
              <label for="inputPassword3" class="col-sm-3 form-control-label">Brand Image1 (Square Image)</label>
              <div class="col-sm-12">
                <input type="file" name="brand_img_sq" class="form-control" >
              </div>
            </div>
            <div class="image_banner">
              <img class="w-40 avatar" src="http://srjcreations.com/asset/<?php echo $brand_rs['brand_image_rc']; ?>">
              <input type="hidden" name="brand_oimage_rc" value="<?php echo $brand_rs['brand_image_rc']; ?>">

            </div>
            <div class="form-group ">
              <label for="inputPassword" class="col-sm-3 form-control-label">Brand Image2 (Rectangle Image)</label>
              <div class="col-sm-12">
                <input type="file" name="brand_img_rc" class="form-control" >
          ...
          <div class="dker p-a text-right">
            <input type="submit" class="btn info" value="upadte" name="submit">
          </div>
        </div>
      </form>
    </div>
