...
include_once 'api/config/database.php';
 ...
 {  
  ...
  if (isset($_GET['id'])) {
            $query = "select * from region_to_country where region_id = ". $_GET['id']." ";
            $result = mysqli_query($connection,$query);
            $country_rs = mysqli_fetch_array($result, MYSQLI_ASSOC);
            $regon_id = $country_rs['region_id'];
...
<div class="row">
    <div class="col-sm-12">
      <form ui-jp="parsley" id="editcountry"  name="addcountry"  method="post" >
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="col-sm-6">
              ...
              <select  class="form-control c-select " name="region">
             <option value="">Please choose Region</option>
              <?php 
                ...
                <option <?php if ($region['region_id'] == $regon_id) echo 'selected' ; ?> value="<?php echo $region['region_id']; ?>"><?php echo $region['region_name']; ?></option>
                    <?php endwhile; ?>
                </select>                       
            </div>
            <div class="col-sm-6">
              <label>Country Name</label>
              <input type="text" name="country_name" value="<?php echo $country_rs['country_name']; ?>"  class="form-control" >                        
            </div>
          </div>
